...
interface PhoneInputProps {
  ...
  initialPhoneNumber?: string; // New prop for initial phone number
}
...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  initialPhoneNumber = "+1", // Default initial value
}) => {
  // const [selectedCountry, setSelectedCountry] = useState<string>("SO");
